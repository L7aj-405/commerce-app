...
export default function AddMember({ store, roles = [] }) {
    ...
    const field = 'w-full px-3 py-2.5 rounded-lg bg-surface-2 border text-content placeholder:text-content-muted focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500';
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                autoFocus
                                className={`${field} ${errors.name ? 'border-red-500/60' : 'border-line'}`}
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`${field} ${errors.email ? 'border-red-500/60' : 'border-line'}`}
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`${field} ${errors.password ? 'border-red-500/60' : 'border-line'}`}
                            />
