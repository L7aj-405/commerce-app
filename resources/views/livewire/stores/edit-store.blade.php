<div class="space-y-6">
    ...
    @include('livewire.stores.settings-layout', ['store' => $store, 'activeTab' => 'general'])

    {{-- Flash --}}
    @if(session('success'))
        <div class="flex items-center gap-3 rounded-xl bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 px-4 py-3 text-sm text-green-800 dark:text-green-300 mb-6">
        ...
        <div class="card space-y-6">
            ...
            <div class="flex items-center justify-end gap-3 pt-2 border-t border-gray-100 dark:border-gray-700">
                ...
                <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                    <svg class="w-4 h-4" wire:loading.remove wire:target="save" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.7" aria-hidden="true">
